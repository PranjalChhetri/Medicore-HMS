...
const Router = {
  ...
  PAGE_META: {
    ...
    interpreter: { title: 'AI Interpreter', sub: 'Multilingual Medical Translation' },
    radiology: { title: 'Radiology AI', sub: 'Imaging diagnostics & scan management' },
  ...
  navigate(page) {
    ...
    const renderers = {
      ...
      interpreter: () => TranslatorPage.render(),
      radiology: () => RadiologyPage.render(),
